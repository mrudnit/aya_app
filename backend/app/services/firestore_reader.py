...
def _read_profile_sync(uid: str) -> dict:
...
def _read_sleep_logs_sync(uid: str, limit: int = 90) -> list[dict]:
    docs = (
...
def _read_nutrition_logs_sync(uid: str, limit: int = 90) -> list[dict]:
    docs = (
...
def _read_activity_logs_sync(uid: str, limit: int = 90) -> list[dict]:
    docs = (
...
def _read_weight_logs_sync(uid: str, limit: int = 90) -> list[dict]:
    docs = (
...
async def read_profile(uid: str) -> dict:
    return await _run(_read_profile_sync, uid)

async def read_sleep_logs(uid: str, limit: int = 90) -> list[dict]:
    return await _run(_read_sleep_logs_sync, uid, limit)

async def read_nutrition_logs(uid: str, limit: int = 90) -> list[dict]:
    return await _run(_read_nutrition_logs_sync, uid, limit)

async def read_activity_logs(uid: str, limit: int = 90) -> list[dict]:
    return await _run(_read_activity_logs_sync, uid, limit)

async def read_weight_logs(uid: str, limit: int = 90) -> list[dict]:
    return await _run(_read_weight_logs_sync, uid, limit)
